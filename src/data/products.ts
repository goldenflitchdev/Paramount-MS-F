...
export const products: Product[] = [
  // Domestic
  {
    ...
    imageUrl: '/images/Cabinet_with_Locker_Drawer.png'
  },
  {
    ...
    imageUrl: '/images/Cabinet_with_Locker_Two_Drawer.png'
  },
  {
    ...
    sizes: ['78" x 36" x 19"', '78" x 40" x 21"'],
    imageUrl: '/images/Cabinet_with_Full_Hanger.png'
  },
  {
    ...
    imageUrl: '/images/Sangam_Twin_Cabinet.png'
  },
  {
    ...
    sizes: ['78" x 40" x 21"'],
    imageUrl: '/images/Cabinet_with_Sari_Box.png'
  },
  // Italian
  {
    ...
    sizes: ['78" x 36" x 21"'],
    imageUrl: '/images/Italian_Cabinet.png'
  },
  {
    ...
    sizes: ['78" x 42" x 21"'],
    imageUrl: '/images/Italian_Sangam_Twin_Cabinet.png'
  },
  // Three Door
  {
    ...
    sizes: ['78" x 48" x 19"'],
    imageUrl: '/images/Three_Door_Cabinet.png'
  },
  // Dressing
  {
    ...
    sizes: ['78" x 54" x 19"'],
    imageUrl: '/images/Single_Dressing_Cabinet.png'
  },
  // Office Cabinet
  {
  ...
  },
  {
    ...
    imageUrl: '/images/Filing_Cabinet.png'
  },
  // Office Table
  {
    ...
    sizes: ['60" x 36" x 30"'],
    imageUrl: '/images/Executive_Table.png'
  },
  // Storage & Racks
  {
    ...
    imageUrl: '/images/Slotted_Angle_Rack.png'
  }
];
