    ...
    <div className="w-full">
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="https://picsum.photos/seed/steel-factory-hero/1920/1080" 
      ...
      <section className="py-24 bg-silver-300/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: 'Domestic Cabinets', img: '/images/Cabinet_with_Locker_Drawer.jpg', desc: 'Premium wardrobes with lockers and mirrors.' },
              { title: 'Office Cabinets', img: '/images/Glass_Door_Cabinet.jpg', desc: 'Storewells, filing cabinets, and glass door units.' },
              { title: 'Italian Series', img: '/images/Italian_Cabinet.jpg', desc: 'Modern aesthetics with Italian hinges and shoe drawers.' },
              { title: 'Office Tables', img: '/images/Executive_Table.jpg', desc: 'Executive and single tables with Nova Pan tops.' }
            ].map((category, idx) => (
